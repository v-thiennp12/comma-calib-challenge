...
from utils import IMAGE_HEIGHT, IMAGE_WIDTH, INPUT_SHAPE, batch_generator, batch_generator_2inputs, batch_generator_2inputs_eval
import utils
...
eval_batch              = batch_generator_2inputs_eval(data_dir_test, x_test, y_test, batch_size, is_training)
